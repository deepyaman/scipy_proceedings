...
As the popularity of Python grew across the data ecosystem, dbt introduced SQL models.

Tools like BigQuery, Snowflake, and even Spark introduced and focused on Pythonic APIs
